...
cl ..\src\hv_stack\windows\timer.c /I"%incpath%\shared" /I"%incpath%\um" /I"%incpath%\ucrt" /I"%ddkpath%\include" /Zi /nologo /W3 /WX /Od /Oi /D"_AMD64_" /D"_M_AMD64" /D"_WIN64" /D"_UNICODE" /D"UNICODE" /Zc:wchar_t /std:c17 /FAcs /Fa"%objpath%\hv_stack\timer.cod" /Fo"%objpath%\hv_stack\timer.obj" /Fd"%objpath%\hv_stack\vc140.pdb" /GS- /Qspectre /TC /c /errorReport:queue
